          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    const Text(
                      'Muhammad Fabregas Garda Samudr', // Nama sudah disesuaikan
                      style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
                        color: Colors.white, // Menambahkan warna putih agar kontras dengan background gradient
                      ),
                    ),
              ...
              const _SectionCard(
                ...
                title: 'Kontak',
                content: Text(
                  'Igas@gmail.com\n+62 877-2000-8578', // Email sudah disesuaikan
                  style: TextStyle(height: 1.4),
                ),
              ),
              _SectionCard(
        ...
        Wrap(
          ...
          children: List.generate(
            8,
              ...
              child: Text('Item ${i + 1}'), // Diperbaiki dari \${i + 1}
            ),
          ),
        ),
        const SizedBox(height: 16),
          ...
          child: GridView.count(
            ...
            children: List.generate(
              6,
                ...
                child: Text('${i + 1}'), // Diperbaiki dari \${i + 1}
              ),
            ),
          ),
        ),
